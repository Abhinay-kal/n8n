...
## Corpus Check
- 123 files · ~140,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 712 nodes · 902 edges · 82 communities (28 shown, 54 thin omitted)
...
## Knowledge Gaps
- **222 isolated node(s):** `backup.sh script`, `{ test, expect }`, `path`, `healthcheck.sh script`, `install.sh script` (+217 more)
